...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 flex flex-col items-center gap-6">
      ...
      <input value={search} onChange={(e) => setSearch(e.target.value)} type="text" placeholder="Search contacts..." className='border-2 border-blue-900 px-4 py-2 w-64 rounded-md' />
