...
export  function ContactCard({ id, firstName, lastName, email, phone, status, createdAt }:Contact) {
    ...
    return (
        <div key={id} onClick={onCardClick} className="w-full  h-56 border border-gray-200 rounded-xl shadow-sm p-6 bg-white hover:shadow-md transition-shadow duration-300 flex flex-col align-center">
